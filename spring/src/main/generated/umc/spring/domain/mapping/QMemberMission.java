...
public class QMemberMission extends EntityPathBase<MemberMission> {
    ...
    public final umc.spring.domain.common.QMission mission;
    ...
    public QMemberMission(Class<? extends MemberMission> type, PathMetadata metadata, PathInits inits) {
        ...
        this.mission = inits.isInitialized("mission") ? new umc.spring.domain.common.QMission(forProperty("mission"), inits.get("mission")) : null;
    }
