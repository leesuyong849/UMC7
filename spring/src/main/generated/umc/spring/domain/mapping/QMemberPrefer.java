...
public class QMemberPrefer extends EntityPathBase<MemberPrefer> {
    ...
    public final umc.spring.domain.common.QFoodCategory foodCategory;

    public final NumberPath<Long> id = createNumber("id", Long.class);

    public final umc.spring.domain.common.QMember member;
    ...
    public QMemberPrefer(Class<? extends MemberPrefer> type, PathMetadata metadata, PathInits inits) {
        ...
        this.foodCategory = inits.isInitialized("foodCategory") ? new umc.spring.domain.common.QFoodCategory(forProperty("foodCategory")) : null;
        this.member = inits.isInitialized("member") ? new umc.spring.domain.common.QMember(forProperty("member")) : null;
    }
